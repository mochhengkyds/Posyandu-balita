        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm" style="border:0;border-radius:10px">
                    <form action="/pasien/{{ $data->id }}/edit" method="POST" class="form-horizontal">
                        @csrf
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fname" name="nama_ibu"
                                        value="{{ $data->nama_ibu }}" placeholder=" isi nama ibu">
                                    @error('nama_ibu')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fname" name="nama_anak"
                                        value="{{ $data->nama_anak }}" placeholder=" isi nama anak">
                                    @error('nama_anak')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fname" name="umur"
                                        value="{{ $data->umur }}" placeholder=" isi umur">
                                    @error('umur')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fname" name="berat_badan"
                                        value="{{ $data->berat_badan }}" placeholder=" isi berat badan">
                                    @error('berat_badan')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="fname" name="alamat"
                                        value="{{ $data->alamat }}" placeholder=" isi alamat">
                                    @error('alamat')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="fname" name="tanggal_lahir"
                                        value="{{ $data->tanggal_lahir }}" placeholder=" isi tanggal lahir">
                                    @error('tanggal_lahir')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="fname" name="tanggal_daftar"
                                        value="{{ $data->tanggal_daftar }}" placeholder=" isi tanggal daftar">
